      ...
      <section class="portfolio" id="portfolio">
          <div class="row">
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumb/1.png" alt="Card image cap">
                <div class="card-body">
                  <h5>JSON</h5>
            ...
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumb/2.png" alt="Card image cap">
                <div class="card-body">
                  <h5>WPU-HUT</h5>
            ...
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumb/3.png" alt="Card image cap">
                <div class="card-body">
                  <h5>WPU-MOVIE</h5>
          ...
          <div class="row">
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumb/4.png" alt="Card image cap">
                <div class="card-body">
                  <h5>WPU-PORTFOLIO</h5>
                  <p class="card-text">Latihan API menggunakan Public API Youtube dan Instagram menggunakan cURL berbasis website.</p>
                  <a href="<?= base_url(); ?>../wpu-portopolio\index.php" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div> 
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumb/5.png" alt="Card image cap">
                <div class="card-body">
            ...
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumb/6.png" alt="Card image cap">
                <div class="card-body">
